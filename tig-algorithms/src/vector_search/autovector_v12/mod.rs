...
pub fn solve_challenge(
    ...
    let search_func = module.load_function("search_v12")?;

    let queries_per_block: u32 = 16;
...
pub fn help() {
    println!("AutoVector v12 — 16 queries/block, 512 threads, 2x DB load amortization");
}
