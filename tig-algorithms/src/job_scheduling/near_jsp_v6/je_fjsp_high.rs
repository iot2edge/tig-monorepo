...
pub fn solve(
    ...
    // Tuned: 500 beats job_eight's default 5000 by +1,652 quality at 10 nonces
    // (q=50,869 vs 49,217). Phase 1 was over-consuming fuel that Phase 2-8
    // refinement uses more productively. See `scripts/compare_algorithms`
    // verification logs in /tmp/jsp_compare_full.log for sweep data.
    let num_restarts = 500;
