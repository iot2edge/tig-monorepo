...
pub fn solve(
    ...
    let compute_moves_kernel = module.load_function("compute_refinement_moves_optimized_200k")?;
    let execute_moves_kernel = module.load_function("execute_refinement_moves_200k")?;
    let balance_kernel = module.load_function("balance_final_200k")?;
    let reset_counters_kernel = module.load_function("reset_counters_200k")?;
    let compute_connectivity_kernel = module.load_function("compute_connectivity_200k")?;
    let perturb_kernel = module.load_function("perturb_solution_200k")?;
    let perturb_guided_kernel = module.load_function("perturb_guided_200k")?;
