        ...
        for _ in 0..max_generations {
            ...
            for uncolored_index in 0..uncolored.len() {
                ...
                unsafe {
                    ...
                    let min_entropy_reduction = *challenge.weights.get_unchecked(mutant) as i32
                    ...
                    for colored_index in 0..coloring.len() {
                        ...
                        if min_entropy_reduction > 0 {
                            let removed_entropy =
                                *challenge.weights.get_unchecked(gene_to_remove) as i32;
                        ...
                        let fitness_change = mutant_fitness
                            - *mutation_rates.get_unchecked(gene_to_remove)
                            - *challenge
                                .interaction_values
                                .get_unchecked(mutant)
                                .get_unchecked(gene_to_remove);
            ...
            if let Some((uncolored_index, colored_index)) = best_crossover {
                ...
                current_entropy = current_entropy + challenge.weights[gene_to_add]
                    - challenge.weights[gene_to_remove];

                unsafe {
                    for flow_index in 0..vertex_count {
                        *mutation_rates.get_unchecked_mut(flow_index) += challenge
                            .interaction_values
                            .get_unchecked(flow_index)
                            .get_unchecked(gene_to_add)
                            - challenge
                                .interaction_values
                                .get_unchecked(flow_index)
                                .get_unchecked(gene_to_remove);
