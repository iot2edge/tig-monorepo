...
pub fn solve(
    ...
    let execute_moves_kernel = module.load_function("execute_refinement_moves_50k")?;
    let balance_kernel = module.load_function("balance_final_50k")?;
    let reset_counters_kernel = module.load_function("reset_counters_50k")?;
    let compute_connectivity_kernel = module.load_function("compute_connectivity_50k")?;
    let perturb_kernel = module.load_function("perturb_solution_50k")?;
    let perturb_guided_kernel = module.load_function("perturb_guided_50k")?;
    ...
    let swap_exhaustive_limit = 256usize;
    let cycle_scan_limit = 16usize;
